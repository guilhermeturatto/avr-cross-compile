...
enum opt_code
{
  ...
  OPT_Waddr_space_convert = 419,             /* -Waddr-space-convert */
  ...
  OPT_Wmisspelled_isr = 621,                 /* -Wmisspelled-isr */
  ...
  OPT_list = 1677,                           /* -list */
  OPT_mabsdata = 1678,                       /* -mabsdata */
  OPT_maccumulate_args = 1679,               /* -maccumulate-args */
  OPT_mbranch_cost_ = 1680,                  /* -mbranch-cost= */
  OPT_mcall_prologues = 1681,                /* -mcall-prologues */
  OPT_mdeb = 1682,                           /* -mdeb */
  OPT_mdouble_ = 1683,                       /* -mdouble= */
  OPT_mfract_convert_truncate = 1684,        /* -mfract-convert-truncate */
  OPT_mgas_isr_prologues = 1685,             /* -mgas-isr-prologues */
  OPT_mint8 = 1686,                          /* -mint8 */
  OPT_mlog_ = 1687,                          /* -mlog= */
  OPT_mlong_double_ = 1688,                  /* -mlong-double= */
  OPT_mmain_is_OS_task = 1689,               /* -mmain-is-OS_task */
  OPT_mmcu_ = 1690,                          /* -mmcu= */
  OPT_mn_flash_ = 1691,                      /* -mn-flash= */
  OPT_mno_interrupts = 1692,                 /* -mno-interrupts */
  OPT_morder1 = 1693,                        /* -morder1 */
  OPT_morder2 = 1694,                        /* -morder2 */
  OPT_mpmem_wrap_around = 1695,              /* -mpmem-wrap-around */
  OPT_mrelax = 1696,                         /* -mrelax */
  OPT_mrmw = 1697,                           /* -mrmw */
  OPT_mshort_calls = 1698,                   /* -mshort-calls */
  OPT_mskip_bug = 1699,                      /* -mskip-bug */
  OPT_msp8 = 1700,                           /* -msp8 */
  OPT_mstrict_X = 1701,                      /* -mstrict-X */
  OPT_mtiny_stack = 1702,                    /* -mtiny-stack */
  OPT_n = 1703,                              /* -n */
  ...
  OPT_nodevicelib = 1710,                    /* -nodevicelib */
  OPT_nodevicespecs = 1711,                  /* -nodevicespecs */
  ...
  OPT_static_libhwasan = 1757,               /* -static-libhwasan */
  OPT_static_liblsan = 1758,                 /* -static-liblsan */
  OPT_static_libmpx = 1759,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1760,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1761,               /* -static-libphobos */
  OPT_static_libstdc__ = 1762,               /* -static-libstdc++ */
  OPT_static_libtsan = 1763,                 /* -static-libtsan */
  OPT_static_libubsan = 1764,                /* -static-libubsan */
  OPT_static_pie = 1765,                     /* -static-pie */
  /* OPT_std_c__03 = 1766, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1767, */                /* -std=c++0x */
  OPT_std_c__11 = 1768,                      /* -std=c++11 */
  OPT_std_c__14 = 1769,                      /* -std=c++14 */
  OPT_std_c__17 = 1770,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1771, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1772, */                /* -std=c++1z */
  OPT_std_c__20 = 1773,                      /* -std=c++20 */
  OPT_std_c__23 = 1774,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1775, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1776, */                /* -std=c++2b */
  OPT_std_c__98 = 1777,                      /* -std=c++98 */
  OPT_std_c11 = 1778,                        /* -std=c11 */
  OPT_std_c17 = 1779,                        /* -std=c17 */
  /* OPT_std_c18 = 1780, */                  /* -std=c18 */
  /* OPT_std_c1x = 1781, */                  /* -std=c1x */
  OPT_std_c2x = 1782,                        /* -std=c2x */
  /* OPT_std_c89 = 1783, */                  /* -std=c89 */
  OPT_std_c90 = 1784,                        /* -std=c90 */
  OPT_std_c99 = 1785,                        /* -std=c99 */
  /* OPT_std_c9x = 1786, */                  /* -std=c9x */
  OPT_std_f2003 = 1787,                      /* -std=f2003 */
  OPT_std_f2008 = 1788,                      /* -std=f2008 */
  OPT_std_f2008ts = 1789,                    /* -std=f2008ts */
  OPT_std_f2018 = 1790,                      /* -std=f2018 */
  OPT_std_f95 = 1791,                        /* -std=f95 */
  OPT_std_gnu = 1792,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1793, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1794, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1795,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1796,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1797,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1798, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1799, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1800,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1801,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1802, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1803, */              /* -std=gnu++2b */
